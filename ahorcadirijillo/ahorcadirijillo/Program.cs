...
namespace Ahordadirijillo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (gano == false)
            {
                ...
                while (SoloUna == 0)
                {
                    ...
                    {
                        Console.Clear();
                        Console.Write("LAS LETRAS VAN UNA POR UNA PADRINO");
                        Console.ReadKey();
                        Console.Clear();
                    }
                }
                for (int k = 0; k < longitud.Length; k++)
                {
                    if (longitud[k] == letraingresachar)
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("ESTA LETRA YA LA PONISTE PA, INGRESA OTRA");
                            Console.ReadKey();
                            repite++;
                        }
                        contador++;
        ...
        static string ElegirPalabra()
        {
            ...
            string[] palabras = { "colmillos", "carretera", "esquizofrenia", "bicicleta", "escritorio" };
            string encontrada;
